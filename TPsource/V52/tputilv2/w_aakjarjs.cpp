...
// Muuntaa wide-merkkisen nimen nimi hakemistojärjestysmerkkijonoksi jrjstr.
// len: jrjstr:n kapasiteetti, wasv: 1=muunna W→V, aatelifl: 1=poista aateliprefiksit (von/van/de jne.); palauttaa jrjstr.
