...
// Muuntaa UCHAR-merkistöisen nimen hakemistojärjestysmerkkijonoksi (vaihtoehtoinen versio W→V-muunnoksella).
// knimi: kilpailijan nimi; poistaa aateliprefiksit ja muuntaa ä/ö/å vertailukelpoisiksi.
