...
// Rekisterˆi emit-koodin (badge) joukkueelle kno emit-indeksiin.
// d = joukkueen tietueen positio; jos 0, joukkueen olemassaolo varmistetaan
//     getpos():lla. Jos joukkuetta ei viel‰ lˆydy indeksist‰ (esim. juuri
//     lis‰tt‰v‰ joukkue), kutsujan on annettava positio, ettei rekisterˆinti
//     ep‰onnistu v‰‰r‰n‰ positiivisena.
// Paluu: 0 = rekisterˆity (tai koodi jo t‰ll‰ joukkueella),
//        1 = joukkuetta ei lˆydy datasta,
...
INT addbadge(INT32 badge, INT kno, INT d, int toinen, INT msgfl)
   ...
   // Ilman tunnettua positiota (d==0) ei rekisterˆid‰ koodia joukkueelle,
   // jota ei viel‰ lˆydy datasta.
   if (!d && (i = getpos(kno)) <= 0)
      return(1);
