...
#### A6.6 Leimantarkastuksen käyttö
...
4. Jos kilpailijan (osuuden juoksijan) numeroa ei löydy, avautuu apukaavake kilpailijan valitsemiseksi.

Leimantarkastuskaavakkeen käytöstä tarkemmin kts. [luku 6.1](6.1_leimantarkastuskaavake.md).

#### A6.7 Kortin tietojen tulkinta
...
sijoittaa osuuden lähtöajan (lähtö, vaihto tai yhteislähtö) kortin aikajanalle
...
lähtöön tai vaihtoon myöhästynyt juoksija, jonka aika lasketaan osuuden
virallisesta lähtöajasta). Muuten ennakoksi tulee 0 ja väliajat lasketaan kortin
...
| Ensimmäisen rastin väliaika puuttuu (–) | Kortilla ei ole lähtö-, nollaus- eikä tarkastusleimaa, tai lähtöaika on yli 3 h ennen nollausta | Käytä lähtö- tai tarkastusasemaa (erityisesti SI5), tarkista lähtöluettelo ja leimasinten kello (kts. A6.7) |
