...
| SRRKORTTIAIKA | SRR-donglen/SIRIT-lukijan (myös Zebra-lukijan, joka muotoilee tagit samaan tekstimuotoon) Air+-leimauksissa tallennetaan oletuksena tietokoneen kello, ei kortin/aseman omaa - mahdollisesti synkronoimatonta - kelloa; molemmat kirjataan lokiin. Tämä parametri palauttaa vanhan toiminnan (kortin/aseman oma aika). |
