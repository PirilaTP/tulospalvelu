...
// Lukee aikasyötteen yhden sadasosasekunnin tarkkuudella (hh.mm.ss,s) INT32-muodossa.
// t: aika (in/out), t0: vertailuaika, l: kentän leveys, x/y: näyttökoordinaatit, term: lopetusmerkit, tc: lopetusmerkki (out).
// Muuttaa *t vain kun syöte on kelvollinen; sentinel-arvo on -24*36000L.
...
// Unicode-versio inputaika_l:sta; muuntaa wide-merkkijonot OEM-merkistöön ennen kutsua.
