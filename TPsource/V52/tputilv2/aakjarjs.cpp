...
// Muuntaa OEM-merkistöisen nimen hakemistojärjestysmerkkijonoksi staattiseen 30-merkin puskuriin.
// knimi: kilpailijan nimi OEM-koodauksessa; poistaa aateliprefiksit (von/van/de/av/af) ja muuntaa ä/ö/å.
