...
// Apufunktiot viestikilpailulle: osuus- ja kilpailijatietojen ylläpito sekä seuraluettelo.
...
void merk_yht_lahdot(int srj, bool nayta)
   ...
   if (os == Sarjat[srj].ntosuus)
	   return;
   if (nayta) {
	   vidspmsg(ySize-1,0,7,0,"Kirjaa yhteisl�ht�j�, sarja :");
