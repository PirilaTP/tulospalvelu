...
Usein on lisättävä yksittäisiä ilmoittautumisia näppäilemällä tiedot
...
osanottajien luetteloa tai seuraluetteloa. (Muutamia muitakin
valintamahdollisuuksia on.)

![](../images/ILmAset.png)

Käytettäessä kaavaketta ilmoittautumisten syöttöön ennen
arvontaa ei ole tarpeen antaa kilpailijanumeroa eikä lähtöaikaa. Sarjan valinta
on välttämätöntä ohjelman toiminnan kannalta, muut tiedot syötetään tarpeen
mukaan. Seuraluettelon käyttö auttaa saamaan seuralyhenteet virheettöminä sekä
pitkät seuranimet mukaan jo tässä vaiheessa. Kun ruksataan *Hae seuraa
seuraluettelosta* aukeaa seuraluettelokaavake, josta on valittava
avattavaksi käytettävä seuraluettelo Seurat.csv. Kun sitten syötetään seuralyhennettä ja painetaan Enter valinnan
osuttua seuraluettelossa oikealle kohdalle, siirtyvät myös pitkä seuranimi ja
aluekoodi, vaikka näitä ei olisi valittu näytettäviksi
