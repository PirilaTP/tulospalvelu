...
Heti kilpailun määrittelyvaiheessa on olennaista vain, että kaikki
...
määriteltäväksi.* Tämän jälkeen täytetään
tarvittavat tiedot ja annetaan sarjalle järjestysnumero siten,
että se asettuu oikealle paikalle sarjaluetteloon
(0 vie viimeiseksi). Kun sarja sitten tallennetaan, kasvatetaan tätä
...
Hiihtokilpailuissa edellyttää tulosten toimittaminen
Hiihtoliitolle, että sarjanimet kertovat sukupuolen ja ikäsarjan kuten kuvassa
sekä sen että matka ilmoitetaan yhdellä desimaalilla ja sen perään liitetään
hiihtotavan kertova kirjain P
tai V (tai näiden yhdistelmä VP, kun laji vaihtuu
kisan aikana).

**Takaa-ajokilpailussa** on valittava
viimeisen vaiheen luonteeksi *Takaa-ajo*
.
