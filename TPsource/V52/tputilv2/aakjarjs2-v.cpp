...
// Muuntaa UCHAR-merkistöisen nimen hakemistojärjestysmerkkijonoksi (v-versio ilman W→V ja _-muunnoksia).
// knimi: kilpailijan nimi; poistaa aateliprefiksit, muuntaa ä/ö/å; tuntemattomat merkit kopioidaan sellaisinaan.
