...
// Kaikki viestikilpailun globaalit muuttujat: säikeiden kriittiset alueet, asetusparametrit ja tilamuuttujat.
...
*/
   ...
   int vainvaliajat;
   char aika_int_mask = 17;    // N�m� kaksi rivi� ovat aina mukana
   int aika_esto=2;            // koska muuttujat esiintyv�t ASYNCH:ssa
