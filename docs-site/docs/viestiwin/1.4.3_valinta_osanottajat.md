...
- **Joukkueet.**
  ...
  - **Näytä maastossa olevat kilpailijat.** Taulukko
    osuuksittain kilpailijoista, joilla on emit-numero ja merkitty
    lähtöaika, mutta ei maaliaikaa kyseisellä osuudella, ja joita ei ole
    merkitty poissaoleviksi, ei-lähteneiksi, vakanteiksi, keskeyttäneiksi
    tai hylätyiksi. Suljettu aiempi osuus ei riitä ilman lähtöaikaa.
