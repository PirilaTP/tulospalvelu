# 6.10 Yhteydet Emit-lukijaan, MTR- ja emiTag-laitteiden ohjaus

### 6.10 Yhteydet Emit-lukijaan, MTR- ja emiTag-laitteiden ohjaus

Kun käytössä on MTR-laite tai emiTag-järjestelmän laite, voi
leimantarkastuskaavakkeen valikosta valita toiminnaksi kyseisen laitteen
...
emiTag-laitteiden käyttöä käsitellään lähemmin [liitteessä 9](liite_9._emitag-laitteiden_kaytto.md)
.
...
erilliseen tiedostoon, voidaan leimantarkastuskaavakkeen valinnassa *Lue
tietoja tiedostosta* valita, mitkä tiedoista otetaan varsinaiseen
käsittelyyn.
...
USB-portissa, mutta saadaan toimimaan toisen USB-portin
kautta.

Emit-laitteen yhteys määritellään sekä [konfiguraatioeditorissa](1.3_toimintatilojen_konfigurointi.md) että
käytön aikana leimantarkastuskaavakkeen valikon kautta avattavalla kaavakkeella
hyvin
samankaltaisesti.
  ...
  - Sarakkeeseen 3 valitaan joko sarjaportti tai
    ...
    - Sarakkeeseen 4 kirjoitetaan tietokoneen sarjaportti
      ...
      - Sarakkeeseen 5 kirjoitetaan laitteen ip-osoite, jos
        ohjelman pitää ottaa yhteys palvelimena toimivaan
        laitteeseen

        - Sarakkeeseen 6 kirjoittaan sarakkeen 5
          ip-osoitteeseen liittyvä
          portti.

          - Sarakkeeseen 7 valitaan hiiren
            avulla mahdollisia ajanottotoiminnan
            valintoja.
