...
// Muuntaa OEM-merkkijonon nimen hakemistojärjestysmerkkijonoksi (vaihtoehtoinen versio ilman W→V-muunnosta).
// knimi: kilpailijan nimi OEM-koodauksessa; poistaa aateliprefiksit ja muuntaa ä/ö/å vertailukelpoisiksi.
