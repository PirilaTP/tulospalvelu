...
// Muuntaa UCHAR-merkistöisen nimen hakemistojärjestysmerkkijonoksi (v-versio aakjarjstr2:sta ilman W→V ja _-muunnoksia).
// knimi: kilpailijan nimi; poistaa aateliprefiksit; tuntemattomat merkit kopioidaan sellaisinaan.
