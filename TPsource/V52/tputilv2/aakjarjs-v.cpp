...
// Muuntaa UCHAR-merkistöisen nimen hakemistojärjestysmerkkijonoksi (vaihtoehtoinen versio ilman _-muunnosta).
// knimi: kilpailijan nimi; poistaa aateliprefiksit ja muuntaa ä/ö/å; tuntemattomat merkit kopioituvat sellaisinaan.
