...
- **Osanottajat.** Taulukko
  ...
  - **Näytä maastossa olevat kilpailijat.** Taulukko
    kilpailijoista, joilla ei ole maaliaikaa ja joita ei ole merkitty
    poissaoleviksi, ei-lähteneiksi, vakanteiksi, keskeyttäneiksi tai
    hylätyiksi. Sarakkeina ovat lähtöpaikka, lähtöaika ja kaikki
    käytössä olevat väliaikapisteet. Listaa voi rajata sarjan mukaan.
    Painike *Hae* päivittää näytön.

  - **Yksi osanottaja.** Suora linkki yhden
    osanottajan tietojen kaavakkeelle. Jos kaavake *Kilpailijatiedot*
    suljetaan muokkaustilassa, ohjelma kysyy *Tallennetaanko muutokset?*
    ja palaa haku- ja katselutilaan, joten seuraava avaus ei jää
    muokkaustilaan.
