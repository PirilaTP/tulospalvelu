...
// Viestikilpailun tuloslistojen kenttämääritykset: näyttö-, tiedosto- ja tulostuskenttien oletusarvot.
...
static wchar_t *FRM_Lajit[] = {L"Kirjoitin_osuus", L"Kirjoitin_kaikki", L"Tiedosto_osuus", L"Tiedosto_kaikki", L"N�ytt�"};
