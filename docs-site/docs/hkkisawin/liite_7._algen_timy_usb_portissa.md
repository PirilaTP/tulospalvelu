# Liite 7. Algen Timy USB portissa
...
Myös tätä menettelyä käytettäessä kannattaa liittää
ennalta
...
Ohjelmasta voi myös pyytää joko kaikkien
Timyn muistissa olevien aikojen uudelleenlähetystä tai loppuosaa valittavasta rivistä alkaen. On huomattava,
