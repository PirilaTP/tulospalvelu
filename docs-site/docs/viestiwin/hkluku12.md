...
Kilpailijatiedot tallennetaan kolmeen tietokantatauluun: vosanotot, osuudet
ja vtulos. Näiden taulujen luomisen toteuttavat SQL-komennot ovat mukana
jakelutiedostossa vkilpsql.txt ja ne asennetaan kilpailutietojen kansioon.

Kaikkien tietojen avaimiin sisältyy kilpailun koodi joka määritellään
kilpailun perusominaisuuksissa sekä kilpailijatiedon sijainti tiedostossa
KILP.DAT, mikä on muuttumaton tieto, ellei järjestystä muuteta esimerkiksi
kirjoittamalla csv-tiedostoon ja lukemalla sieltä takaisin eri järjestyksessä.
(Poistetut tietueet voivat muuttaa sijainteja näin toimittaessa.)
